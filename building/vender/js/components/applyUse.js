				...
				<v-dialog v-model="dialog" width="98%">
					<v-card>
														...
														<div class="card" style="min-height: 200px;">
															<div class="card-body" >
																...
																<table class="ApplyListLand" style="text-align:left; ">
																	<tr id="ApplyTr1" >
																		<th style="min-width:8%;text-align:left ; padding-right:10px">序號</th>
																		<th style="width:25%" >地段</th>
																		<th style="width:65%">地號</th>
																	</tr>
																	<tr class="ApplyTr2" v-for="(list,key) in applyLand">
																		<td style="text-align:left; padding: 0 10px">{{key+1}}</td>
																		<td>{{list.title}}</td>
																		<td>{{list.content}}</td>
																	</tr>
																</table>
						...
						<v-card-actions style="justify-content: center">
							<v-btn color="#0B4873" style="color:white" elevation="1" raised @click="editBtn"
								v-show=!show>
								編輯
							</v-btn>
							<v-btn color="#0B4873" style="color:white" elevation="1" raised v-show=show
								@click="cancelBtn">
								取消
							</v-btn>
							<v-btn color="#0B4873" style="color:white" elevation="1" raised v-show=show @click="save">
								確認修改
							</v-btn>
							<v-btn color="#0B4873" style="color:white" elevation="1" raised @click="buJianListBtn">
								補件處理
							</v-btn>
							<v-btn color="red accent-4" style="color:white" elevation="1" raised @click="returned()">
								退件處理
							</v-btn>
							<v-btn color="#0B4873" style="color:white" elevation="1" raised @click="keepDateBtn()">
								展延
							</v-btn>
										...
										<div class="card-body">
											...
											<div class="input row-cols-12">
												<div class="col-12">
													...
													<input type="text" placeholder="加註事項">
												</div>
											</div>
											<v-card-actions style="display:block">
												<v-btn color="#0B4873" style="color:white" elevation="1" raised
