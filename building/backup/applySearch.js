let search = Vue.extend({
				...
				<template v-slot:top>
							...
							<v-card-text>
								<v-container>
									<v-row>
										...
										<v-col cols="12" sm="6" md="4">
											<v-text-field v-model="editedItem.place" label="place">
											</v-text-field>
										</v-col>
										<v-col cols="12" sm="6" md="4">
											<v-text-field v-model="editedItem.placeNum" label="placeNum">
											</v-text-field>
										</v-col>
										<v-col cols="12" sm="6" md="4">
										...
										<v-col cols="12" sm="6" md="4">
											<v-text-field v-model="editedItem.getNum" label="getNum">
											</v-text-field>
										</v-col>
									</v-row>
								</v-container>
					...
					<v-dialog v-model="dialogDelete" max-width="500px">
						<v-card>
							...
							<v-card-actions>
								<v-spacer></v-spacer>
								<v-btn color="blue darken-1" text @click="closeDelete">取消
								</v-btn>
								<v-btn color="blue darken-1" text @click="deleteItemConfirm">確定
								</v-btn>
								<v-spacer></v-spacer>
							</v-card-actions>
						</v-card>
	...
	mounted() {
		...
		// console.log(document.querySelectorAll("v-text-field"));
	},
	methods: {
		initialize() {
			this.totalList = [
