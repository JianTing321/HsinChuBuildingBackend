									...
									<div class="card">
										<div class="card-body">
											...
											<v-card-actions style="display:block">
												<v-btn color="#0B4873" style="color:white" elevation="1" raised  @click="save">
													取消
												</v-btn>
												<v-btn color="#0B4873" style="color:white" elevation="1" raised  @click="close">
													儲存
												</v-btn>
										...
										<div class="card-body">
											...
											<div class="input row-cols-12">
												<div class="col-12">
													...
													<textarea name="" id="" style="height:80px" placeholder="請輸入事項"></textarea>
												</div>
											</div>
